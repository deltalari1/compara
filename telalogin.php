...
<body class="body">
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center inner-row" style="margin-top: -161px;">
            <div class="col-auto col-lg-5 col-md7">
                <div class="form-box login-form p-md-5 p-3">
                    ...
                    <div class="mt-3">
                        <span>Não tem uma conta? </span><button class="p-0 border-0 bg-transparent primaryColor singup-show">Registre-se</button>
                    </div>
                </div>
            </div>
        </div>
